...
)
{
 ...
 retryRequest(request): void {
  ...
  getMethood(urlWithParams, header) {
    return this.http.get(urlWithParams, { headers: header })
    .subscribe(
  ...
  deleteMethood(urlWithParams, header) {
    return this.http.delete(urlWithParams, { headers: header })
    .subscribe(
      data => console.log('data',data),
      err => console.log('err',err),
      () => console.log('yay')
  ...
  postMethood(urlWithParams, body, header) {
    return this.http.post(urlWithParams, body, { headers: header })
    .subscribe(
      data => console.log('data',data),
      err => console.log('err',err),
      () => console.log('yay')
  ...
  putMethood(urlWithParams, body, header) {
    return this.http.put(urlWithParams, body, { headers: header })
    .subscribe(
      data => console.log('data',data),
      err => console.log('err',err),
      () => console.log('yay')
