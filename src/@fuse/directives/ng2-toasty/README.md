...
System.config({
    map: {
        'ng2-toasty': '@fuse/directives/ng2-toasty/bundles/index.umd.js'
...
- Import `ToastyService` from `@fuse/directives/ng2-toasty` in your application code:

```js
import {Component} from '@angular/core';
import {ToastyService, ToastyConfig, ToastOptions, ToastData} from '@fuse/directives/ng2-toasty';
...
```js
import {Component} from '@angular/core';
import {ToastyService, ToastyConfig, ToastyComponent, ToastOptions, ToastData} from '@fuse/directives/ng2-toasty';
