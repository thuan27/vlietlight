...
export class CreateMonthlyCostsComponent implements OnInit {
  ...
  onSubmit() {
    if (this.MonthlyCostsForm.valid) {
      if (this.action === 'create') {
        this._createMonthlyCostsService.createCountry(this.MonthlyCostsForm.value).subscribe((data) => {
        ...
        this._createMonthlyCostsService.updateCountry(this.idMonthlyCosts, this.MonthlyCostsForm.value).subscribe((data) => {
          this.toastyService.success(data['message']);
          setTimeout(
            () => {
              this.router.navigate(['apps/master-data/range-price']);
  ...
  detail(id) {
    this._createMonthlyCostsService.getCountryDetail(id).subscribe((data) => {
