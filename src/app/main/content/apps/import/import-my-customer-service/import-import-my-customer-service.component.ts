...
@Component({
  selector: 'import-import-my-customer-service',
  templateUrl: './import-import-my-customer-service.component.html',
  styleUrls: ['./import-import-my-customer-service.component.scss'],
  animations   : fuseAnimations,
  encapsulation: ViewEncapsulation.None,
  providers: [UserService, ToastyService, FileManagerService],

})
export class ImportMyCustomerServiceComponent implements OnInit {
  selected: any;
  pathArr: string[];
  hasImportMyCustomerService;
  itemFile:any;
  ...
  importFile() {
      ...
      that.toastyService.error('Only upload file extend .xlsx !!!')
		...
		xhr.open("POST", `${that.apiConfig.IMPORT_MY_CUSTOMER_SERVICE}`, true);
		...
		xhr.onreadystatechange = function() {
          ...
          that.toastyService.error('Import file has some errors.')
					...
					FileSaver.saveAs(blob, 'MyCustomerService_Error.xlsx');
				} else {
					let msg = '';
