...
export class CreateOrderComponent implements OnInit {
  ...
  onSubmit() {
    if (this.CountryForm.valid) {
      if (this.action === 'create') {
        this._createOrderService.createCountry(this.CountryForm.value).subscribe((data) => {
        ...
        this._createOrderService.updateCountry(this.idCountry, this.CountryForm.value).subscribe((data) => {
          this.toastyService.success(data['message']);
          setTimeout(
            () => {
              this.router.navigate(['apps/master-data/countries']);
  ...
  detail(id) {
    this._createOrderService.getCountryDetail(id).subscribe((data) => {
