...
import { CusPriceListService } from './cus-price/cus-price-list/cus-price-list.service';
import { CreateCusPriceService } from './cus-price/create-price-cus/create-cus-price.service';
...
@NgModule({
	declarations: [
		...
		CreateCusPriceComponent,
		CusPriceListComponent
	],
	imports: [
		CommonModule,
