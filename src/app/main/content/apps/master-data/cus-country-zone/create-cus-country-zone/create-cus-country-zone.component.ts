...
class CreateCusCountryZoneComponent implements OnInit {
	items: FormArray;
	...
	onSubmit() {
		if (this.CountryForm.valid) {
			if (this.action === 'create') {
				this._createCusCountryZoneService.createCountryList(this.CountryForm.value).subscribe(
					(data) => {
				...
				this._createCusCountryZoneService.updateCountry(this.idCountry, this.CountryForm.value).subscribe(
					(data) => {
						this.toastyService.success(data['message']);
						setTimeout(() => {
							this.router.navigate([ 'apps/master-data/countries-zone' ]);
